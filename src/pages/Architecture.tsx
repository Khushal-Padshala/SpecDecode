    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 py-4">
      ...
      <div className="rounded-2xl border border-pink-200/80 bg-white/95 p-6 sm:p-8 space-y-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 text-xs">
          ...
          <div className="p-4 rounded-xl bg-pink-50/50 border border-pink-200/70 space-y-2.5 shadow-xs">
            <div className="text-rose-700 font-bold font-mono uppercase text-[11px] flex items-center gap-1.5">
              <span>01.</span> Memory Bandwidth Bound
            </div>
            <h4 className="text-sm font-bold text-slate-900">Standard Autoregression</h4>
          ...
          <div className="p-4 rounded-xl bg-pink-50/50 border border-pink-200/70 space-y-2.5 shadow-xs">
            <div className="text-pink-700 font-bold font-mono uppercase text-[11px] flex items-center gap-1.5">
              <span>02.</span> Lightweight Draft
            </div>
            <h4 className="text-sm font-bold text-slate-900">Small Model Arithmetic</h4>
            <p className="text-slate-700 leading-relaxed">
          ...
          <div className="p-4 rounded-xl bg-pink-50/50 border border-pink-200/70 space-y-2.5 shadow-xs">
            <div className="text-emerald-700 font-bold font-mono uppercase text-[11px] flex items-center gap-1.5">
              <span>03.</span> Parallel Verification
            </div>
            <h4 className="text-sm font-bold text-slate-900">Compute Bound Batches</h4>
            <p className="text-slate-700 leading-relaxed">
        ...
        <div className="p-4 rounded-xl bg-pink-50/70 border border-pink-200 space-y-2 text-xs">
